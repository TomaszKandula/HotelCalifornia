...
export default function MainPage() 
{
    return (
        <Jumbotron>
            ...
            <p>This web site is an example of a web application requested by client.</p>
            <p>To book the room, please click "User page".</p>
            <p>To see the bookings, please click "Manager page".</p>
            <p>We offer:</p>
            <ul>
                <li>
